...
"name": "VacQ",
"description": "Backend API for reserving Vaccine jab timeslots, including Providers, users, and bookings.",
...
"",
"pm.test(\"there are some Providers!!\", () => {",
"    pm.expect(response.count).to.be.above(0);",
"});",
"",
"pm.execution.setNextRequest(\"Create New Provider\");"
],
...
"description": "Fetch all Providers from database."
},
"response": []
},
{
...
"const new_Provider_id = response.data.id;\r",
"\r",
"pm.globals.set(\"global_Provider_id\", new_Provider_id);\r",
"\r",
"pm.execution.setNextRequest(\"Get Single Provider\");"
],
"type": "text/javascript",
"packages": {}
}
...
"});",
"",
"pm.execution.setNextRequest(\"Update Single Provider\");"
],
"type": "text/javascript",
"packages": {}
}
...
"header": [],
"url": {
"raw": "{{URL}}/api/v1/Providers/:Provider_ID",
"host": [
"{{URL}}"
],
"path": [
...
"});",
"",
"pm.execution.setNextRequest(\"Delete Single Provider\");"
],
"type": "text/javascript",
"packages": {}
}
...
"description": "Providers CRUD functionality"
},
{
"name": "Authentication",
"item": [
